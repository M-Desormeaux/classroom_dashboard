...
export const StudentCard = ({ studentID, name, avg }: Student) => {
  return (
    <div className="flex w-full flex-col gap-1 rounded-md bg-gray-100 px-4 py-2 sm:flex-row sm:justify-between">
      <div className="flex w-full items-center gap-2">
        <div className="aspect-square w-14 rounded-full bg-gray-400" />
        <div className="flex flex-col gap-1">
          <h2 className="text-xl font-semibold">{name}</h2>
          <span className="flex items-center justify-between gap-1 sm:w-16">
            Avg:
            <span>
